...
public class DevInCarDbContext : DbContext
{
    ...
    public DevInCarDbContext(IConfiguration configuration2)
    {
    ...
    //Imcmentação para autenticação
    //public DevInCarDbContext(DbContextOptions<DevInCarDbContext> options) : base(options) { }


    //Não há necessidade do código abaixo

    //protected override void OnModelCreating(ModelBuilder builder)
    //{
    //    base.OnModelCreating(builder);
    //}
    //Fim da imclementação
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        //    _configuration.GetConnectionString("DEVCAR")
        //);
        optionsBuilder.UseSqlServer(
            _configuration.GetConnectionString("DEVCAR")
        );
